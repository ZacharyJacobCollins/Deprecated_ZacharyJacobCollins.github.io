		...
		<div class="center">
			...
			<div class="row">
				<ul>
					...
					<li>June 8, 2017.  Spent about a month in a really weird situation crushing on a girl that wasn't into me.</li>
...
<script>
	...
	import GithubApi from '../mixins/GithubApi.js'

	export default {
	  name: 'year-in-review-view'
	}
